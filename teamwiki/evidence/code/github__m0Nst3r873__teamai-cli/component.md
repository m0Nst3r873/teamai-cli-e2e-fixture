---
title: github__m0Nst3r873__teamai-cli component
...
- `deepEnrich` ← src/deep-enrich.ts:429 [EXTRACTED]
  ...
  ```
- `generateDigest` ← src/digest.ts:245 [EXTRACTED]
  ```
...
- `tagsRemove` ← src/tags.ts:172 [EXTRACTED]
  ...
  ```
- `mergeStats` ← src/team-push.ts:59 [EXTRACTED]
  ```
  export function mergeStats(
  ```
- `reportUsageToTeam` ← src/team-push.ts:99 [EXTRACTED]
  ```
